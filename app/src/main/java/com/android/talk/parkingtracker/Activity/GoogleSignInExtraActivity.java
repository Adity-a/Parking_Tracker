...
public class GoogleSignInExtraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.registerExtraBtnRegister).setOnClickListener(new View.OnClickListener() {
            @Override
